...
chat::Message::Message(
    ...
    const std::shared_ptr<const chat::message::event::OnClick> &clickEvent,
...
// Getters
const std::shared_ptr<const chat::message::event::OnClick> &chat::Message::getClickEvent() const
{
    return _clickEvent;
}
const std::shared_ptr<const chat::message::event::OnHover> &chat::Message::getHoverEvent() const
{
    return _hoverEvent;
}
const std::string &chat::Message::getMessage() const
{
    return this->_message;
}
const chat::message::Style &chat::Message::getStyle() const
{
    return this->_style;
}
const chat::message::Options &chat::Message::getOptions() const
{
    return this->_options;
}
const std::vector<chat::Message> &chat::Message::getExtra() const
{
    return _extra;
}

// Getters (mutable)
void chat::Message::clickEvent(const std::shared_ptr<const chat::message::event::OnClick> &event)
{
    _clickEvent = event;
}
void chat::Message::hoverEvent(const std::shared_ptr<const chat::message::event::OnHover> &event)
{
    _hoverEvent = event;
}
...
chat::message::Style &chat::Message::style()
{
    return this->_style;
}
