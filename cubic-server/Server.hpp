...
#define SHAPE_CONVERTER Server::getInstance()->getShapeConverter()
...
public:
    ...
    NODISCARD const Shapes::ShapeConverter &getShapeConverter() const { return _shapesConverter; }
...
private:
    ...
    Shapes::ShapeConverter _shapesConverter;
    Recipes _recipes;
