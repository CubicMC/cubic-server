...
bool CollisionSystem::doesCollide(const Entity &entity) const { return !getCollisions(entity).empty(); }

bool CollisionSystem::doesCollideWithBlocks(const Entity &entity) const { return !getCollisionsWithBlocks(entity).empty(); }

bool CollisionSystem::doesCollideWithEntities(const Entity &entity) const { return !getCollisionsWithEntities(entity).empty(); }
