...
public:
    ...
    constexpr T dot_product(const Vector3 &other) const noexcept { return this->x * other.x + this->y * other.y + this->z * other.z; }
...
template <typename T> constexpr std::ostream &operator<<(std::ostream &o, const Vector3<T> &v)
{
    o << "x : " << v.x << " | "
      << "y : " << v.y << " | "
      << "z : " << v.z;
