...
public:
    ...
    {
        return std::sqrt(std::pow((other.x - this->x), 2) + std::pow((other.z - this->z), 2));
    }
    ...
    constexpr T dotProduct(const Vector2 &other) noexcept
    {
    ...
    {
        return Vector2<T>(other.x + this->x, other.z + this->z);
    }

    constexpr Vector2 operator+(const T &other) noexcept
    {
        return Vector2<T>(other + this->x, other + this->z);
    }
    ...
    constexpr Vector2 operator%(const Vector2 &other) noexcept
    {
        return Vector2<T>(other.x % this->x, other.z % this->y, other.z % this->z);
    }
    ...
    {
        return this->x == other && this->z == other;
    }

    constexpr bool operator!=(const Vector2 &other) noexcept
    {
        return this->x != other.x || this->z != other.z;
    }
