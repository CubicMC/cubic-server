...
void LevelData::save(const std::string &folder)
{
    nbt::Compound data(
        "Root",
        {std::make_shared<nbt::Compound>(
            ...
            std::initializer_list<std::shared_ptr<nbt::Base>> {
                ...
                std::make_shared<nbt::Compound>(
                    "DimensionData",
                    std::initializer_list<std::shared_ptr<nbt::Base>> {std::make_shared<nbt::Compound>(
                        "1",
                        std::initializer_list<std::shared_ptr<nbt::Base>> {std::make_shared<nbt::Compound>(
                            "DragonFight",
                            std::initializer_list<std::shared_ptr<nbt::Base>> {
                ...
                std::make_shared<nbt::Compound>(
                    "Version",
                    std::initializer_list<std::shared_ptr<nbt::Base>> {
                        std::make_shared<nbt::Int>("Id", this->mcVersion.id), std::make_shared<nbt::String>("Name", this->mcVersion.name),
                        std::make_shared<nbt::String>("Series", this->mcVersion.series), std::make_shared<nbt::Byte>("Snapshot", this->mcVersion.snapshot)}
                ),
