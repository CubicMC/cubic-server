...
const std::vector<generation::Generator::FeatureBlock> OakTree::getTree(const Position &pos) const
{
    ...
    Tree::buildTree(
        ...
        Blocks::OakLeaves::toProtocol(
            Blocks::OakLeaves::Properties::Distance::ONE, Blocks::OakLeaves::Properties::Persistent::FALSE,
...
const std::vector<generation::Generator::FeatureBlock> OakTree::getTree(
