...
void PineTree::layerWithoutCorner(
...
void PineTree::makeMushroomPine(
    UNUSED const int treeSize, std::vector<generation::Generator::FeatureBlock> &tree, int y, const BlockId &leaf,
    const BlockId &log
) const
{
...
const std::vector<generation::Generator::FeatureBlock> PineTree::getTree(const Position &pos) const
{
    ...
    PineTree::buildTree(
        ...
        Blocks::SpruceLeaves::toProtocol(
            Blocks::SpruceLeaves::Properties::Distance::ONE, Blocks::SpruceLeaves::Properties::Persistent::FALSE,
            Blocks::SpruceLeaves::Properties::Waterlogged::FALSE
        ),
        Blocks::SpruceLog::toProtocol(Blocks::SpruceLog::Properties::Axis::Y)
    );
    return tree;
...
const std::vector<generation::Generator::FeatureBlock> PineTree::getTree(
