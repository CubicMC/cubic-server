...
void SpruceTree::repetitivePattern(
    std::vector<generation::Generator::FeatureBlock> &tree, int y, const BlockId &leaf, const BlockId &log,
    UNUSED int treeSize
) const
{
...
const std::vector<generation::Generator::FeatureBlock> SpruceTree::getTree(
