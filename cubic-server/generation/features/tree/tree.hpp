...
protected:
    ...
    virtual const std::vector<generation::Generator::FeatureBlock> getTree(
     ...
     */
    void placeLeaf(std::vector<generation::Generator::FeatureBlock> &tree, generation::Generator::FeatureBlock block)
        const;
