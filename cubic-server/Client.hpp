...
#define PARSER_IT_DECLARE(state)   \
    std::unordered_map<            \
        protocol::ServerPacketsID, \
        std::function<std::unique_ptr<protocol::BaseServerPacket>(std::vector<uint8_t> &)>>::const_iterator __##state
...
constexpr const char DEFAULT_FAVICON[] = "data:image/"
                                         "png;base64,"
                                         "iVBORw0KGgoAAAANSUhEUgAAAEAAAABABAMAAABYR2ztAAAAGFBMVEUStBFePiFHcEyPYTlEaCGol"
                                         "m4XIwsoemIehfltAAAABnRSTlP9/QD7c/"
                                         "h561WQAAACPUlEQVRIx32VTXPbIBCGtx0XX02pdU5T/"
                                         "QG6Vs4J8aTXto4mVzTKoKsPjf33u4s+EEiY0chj3od3dwEB3Mft17ekA+K/"
                                         "ZeHMLYD0S2fyAOnUGpMDyhfWhXs3GeCJdde5y/"
                                         "s6MOrCun+"
                                         "rwMuFZQoRWcwB17fOugwgBsLZ2w5CZENMFlkHGmxtNofSTc2sT9SRCqRHuGNuLYY0N9m1AJqEwlnI"
                                         "rEUJFrqPtx0ArOZQAgjxpa5/"
                                         "Q0QEgGQQWw98go1ZAI88EOzHm/+FTQo8WlKtFVuAmIBx/"
                                         "M7uIGqbOXBHw9mBn6l9DkDpw/"
                                         "fd10CYCbjrE7S0VldqZ6BntJiALVy77hraErhG7RwB32n+"
                                         "Y4J04b7OACaS8S4GYsLrzc8A8DcJgfD6AggEcAIR8MMDbkj03Out+"
                                         "psCPTHoDeIS4GJH/"
                                         "YRqEcITvU4GOslBToTXpUyrkHIohd9S6bhM6sNCsonlAEoznYRQsuBeBlrt4yUhtNKKPBhQulgBpE"
                                         "KpsWgY6ItKclCKDFBzInooOl5NSRqiVjocA"
                                         "sk8SA4iR4DCtPFUo3eQsgfaunDNEtCo8Y8H9qeHxTxon6QHGqz0csMo7+"
                                         "FDVPWpWAK0AVSfJCJyhwxllk+eYA/Ubl97XR3Cp3df4uhB61RXD/ynMvPPv/TVSQpC/"
                                         "trDJj5ASr8duNJYD0fQsfdQiT47xJ79JlDo369r5+Qzj235tT+sn7Ts0RAgD7mjmAgC1CF/"
...
public:
    ...
    NODISCARD inline std::thread &getThread()
    {
        return _thread;
    };
...
private:
    ...
    NODISCARD inline const std::vector<protocol::PlayerProperty> &getProperties() const
    {
        return _resPck.properties;
    }
