...
typedef bool (*onPlayerChat)(
    PluginInterface *interface, Player *player, Chat *chat, std::string message
);                                                                         // TODO - Place event
...
typedef bool (*onEntityInteractBlock)(
    PluginInterface *interface, Entity *entity, int32_t block_id
); // Todo - Place event
...
typedef bool (*onBlockInteract)(
    PluginInterface *interface, int32_t block_id, Vector3<int> position, Entity *entity
);                                                                                                 // Todo - ?
typedef bool (*onInventoryOpen)(PluginInterface *interface, Player *player, Inventory *inventory); // Todo - Place event
typedef bool (*onInventoryClose)(
    PluginInterface *interface, Player *player, Inventory *inventory
);                                                                                   // Todo - Place event
