...
constexpr uint8_t *parse(
    uint8_t *&begin, uint8_t *end, H &out, F (*parser)(uint8_t *&begin, uint8_t *end), J H::*field, Args... args
)
{
...
constexpr void serialize(
    std::vector<uint8_t> &out, const H &data, void (*serializer)(std::vector<uint8_t> &, const F &), const Args &...args
)
{
