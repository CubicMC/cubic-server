...
{
    return _impl.IsDefined() && _impl.IsSequence();
}
bool configuration::Node::isScalar() const
{
    return _impl.IsDefined() && (_impl.IsScalar() || _impl.IsNull());
}
bool configuration::Node::isMap() const
{
    return _impl.IsDefined() && _impl.IsMap();
}
bool configuration::Node::isDefined() const
{
    return _impl.IsDefined();
}
