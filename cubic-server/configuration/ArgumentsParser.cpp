...
bool configuration::ArgumentsParser::has(const std::string &argument) const { return this->_impl->is_used(argument); }

std::string configuration::ArgumentsParser::get(const std::string &argument) const { return this->_impl->get<std::string>(argument); }

void configuration::ArgumentsParser::parse(const std::vector<std::string> &args) { this->_impl->parse_args(args); }
...
std::ostream &configuration::operator<<(std::ostream &os, const configuration::ArgumentsParser &parser) { return os << *parser._impl; }
