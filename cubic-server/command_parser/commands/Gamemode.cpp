...
void command_parser::Gamemode::autocomplete(UNUSED std::vector<std::string> &args, std::shared_ptr<Player> invoker) const
{
    if (invoker)
        return;
    else
...
void command_parser::Gamemode::execute(UNUSED std::vector<std::string> &args, std::shared_ptr<Player> invoker) const
{
...
void command_parser::Gamemode::help(UNUSED std::vector<std::string> &args, std::shared_ptr<Player> invoker) const
{
    if (!invoker)
        LINFO("Usage : {}", _help);
}
