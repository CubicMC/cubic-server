...
{
    LDEBUG(
        "Item created at (x: {}, y: {}, z: {}) with entity id {} and item id {}", pos.x, pos.y, pos.z, _id, _slot.itemID
    );
    this->forceSetPosition(pos);
    this->_nbTicksBeforePickable = isDroppedWillinglyByEntity
        ? 40
        : 10; // When dropped by player, dolphin or fox. Else it is 10 ticks
