...
const ArmorPiece armors[25] = {
    turtle::helmet,        leather::helmet,     leather::chestplate,   leather::leggings,   leather::boots,
    golden::helmet,        golden::chestplate,  golden::leggings,      golden::boots,       chainmail::helmet,
    chainmail::chestplate, chainmail::leggings, chainmail::boots,      iron::helmet,        iron::chestplate,
    iron::leggings,        iron::boots,         diamond::helmet,       diamond::chestplate, diamond::leggings,
    diamond::boots,        netherite::helmet,   netherite::chestplate, netherite::leggings, netherite::boots,
};
