...
std::unique_ptr<Recipe> Smithing::create(const std::string &identifier, const nlohmann::json &recipe) { return (std::make_unique<Smithing>(Smithing(identifier, recipe))); }
} // namespace Recipe
