...
std::unique_ptr<Recipe> SpecialSuspiciousStew::create(const std::string &identifier, const nlohmann::json &recipe)
{
    return (std::make_unique<SpecialSuspiciousStew>(SpecialSuspiciousStew(identifier, recipe)));
}
} // namespace Recipe
