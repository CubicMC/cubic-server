...
std::unique_ptr<Recipe> SpecialRepairItem::create(const std::string &identifier, const nlohmann::json &recipe) { return (std::make_unique<SpecialRepairItem>(SpecialRepairItem(identifier, recipe))); }
} // namespace Recipe
