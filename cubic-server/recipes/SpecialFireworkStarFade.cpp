...
std::unique_ptr<Recipe> SpecialFireworkStarFade::create(const std::string &identifier, const nlohmann::json &recipe) { return (std::make_unique<SpecialFireworkStarFade>(SpecialFireworkStarFade(identifier, recipe))); }
} // namespace Recipe
