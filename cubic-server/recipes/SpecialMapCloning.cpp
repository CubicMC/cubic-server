...
std::unique_ptr<Recipe> SpecialMapCloning::create(const std::string &identifier, const nlohmann::json &recipe)
{
    return (std::make_unique<SpecialMapCloning>(SpecialMapCloning(identifier, recipe)));
}
} // namespace Recipe
