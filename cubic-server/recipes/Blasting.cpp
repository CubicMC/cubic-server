...
std::shared_ptr<Recipe> Blasting::create(const std::string &identifier, const nlohmann::json &recipe)
{
    return (std::make_shared<Blasting>(Blasting(identifier, recipe)));
}
} // namespace Recipe
