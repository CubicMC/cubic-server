    ...
    namespace NoteBlock {
        ...
        BlockId paletteToProtocol(std::vector<std::pair<std::string, std::string>> properties) {
            ...
            for (auto prop : properties) {
                if (prop.first == "instrument") {
                    if (prop.second == "harp") {
                        instrument = Properties::Instrument::HARP;
                    } else if (prop.second == "basedrum") {
                        instrument = Properties::Instrument::BASEDRUM;
                    } else if (prop.second == "snare") {
                        instrument = Properties::Instrument::SNARE;
                    } else if (prop.second == "hat") {
                        instrument = Properties::Instrument::HAT;
                    } else if (prop.second == "bass") {
                        instrument = Properties::Instrument::BASS;
                    } else if (prop.second == "flute") {
                        instrument = Properties::Instrument::FLUTE;
                    } else if (prop.second == "bell") {
                        instrument = Properties::Instrument::BELL;
                    } else if (prop.second == "guitar") {
                        instrument = Properties::Instrument::GUITAR;
                    } else if (prop.second == "chime") {
                        instrument = Properties::Instrument::CHIME;
                    } else if (prop.second == "xylophone") {
                        instrument = Properties::Instrument::XYLOPHONE;
                    } else if (prop.second == "iron_xylophone") {
                        instrument = Properties::Instrument::IRON_XYLOPHONE;
                    } else if (prop.second == "cow_bell") {
                        instrument = Properties::Instrument::COW_BELL;
                    } else if (prop.second == "didgeridoo") {
                        instrument = Properties::Instrument::DIDGERIDOO;
                    } else if (prop.second == "bit") {
                        instrument = Properties::Instrument::BIT;
                    } else if (prop.second == "banjo") {
                        instrument = Properties::Instrument::BANJO;
                    } else if (prop.second == "pling") {
                        instrument = Properties::Instrument::PLING;
                    } else {
                        throw std::runtime_error("Invalid property \"instrument\" value");
                    }
                } else if (prop.first == "note") {
                    if (prop.second == "0") {
                        note = Properties::Note::ZERO;
                    } else if (prop.second == "1") {
                        note = Properties::Note::ONE;
                    } else if (prop.second == "2") {
                        note = Properties::Note::TWO;
                    } else if (prop.second == "3") {
                        note = Properties::Note::THREE;
                    } else if (prop.second == "4") {
                        note = Properties::Note::FOUR;
                    } else if (prop.second == "5") {
                        note = Properties::Note::FIVE;
                    } else if (prop.second == "6") {
                        note = Properties::Note::SIX;
                    } else if (prop.second == "7") {
                        note = Properties::Note::SEVEN;
                    } else if (prop.second == "8") {
                        note = Properties::Note::EIGHT;
                    } else if (prop.second == "9") {
                        note = Properties::Note::NINE;
                    } else if (prop.second == "10") {
                        note = Properties::Note::TEN;
                    } else if (prop.second == "11") {
                        note = Properties::Note::ELEVEN;
                    } else if (prop.second == "12") {
                        note = Properties::Note::TWELVE;
                    } else if (prop.second == "13") {
                        note = Properties::Note::THIRTEEN;
                    } else if (prop.second == "14") {
                        note = Properties::Note::FOURTEEN;
                    } else if (prop.second == "15") {
                        note = Properties::Note::FIFTEEN;
                    } else if (prop.second == "16") {
                        note = Properties::Note::SIXTEEN;
                    } else if (prop.second == "17") {
                        note = Properties::Note::SEVENTEEN;
                    } else if (prop.second == "18") {
                        note = Properties::Note::EIGHTEEN;
                    } else if (prop.second == "19") {
                        note = Properties::Note::NINETEEN;
                    } else if (prop.second == "20") {
                        note = Properties::Note::TWENTY;
                    } else if (prop.second == "21") {
                        note = Properties::Note::TWENTY_ONE;
                    } else if (prop.second == "22") {
                        note = Properties::Note::TWENTY_TWO;
                    } else if (prop.second == "23") {
                        note = Properties::Note::TWENTY_THREE;
                    } else if (prop.second == "24") {
                        note = Properties::Note::TWENTY_FOUR;
                    } else {
                        throw std::runtime_error("Invalid property \"note\" value");
                    }
            ...
            return toProtocol(instrument, note, powered);
        }
    }
