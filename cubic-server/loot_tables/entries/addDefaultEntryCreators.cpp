...
{
    Server::getInstance()->getLootTableSystem().addEntryCreator(
        "minecraft", "alternatives", LootTable::Entry::Alternative::creator
    );
    Server::getInstance()->getLootTableSystem().addEntryCreator(
        "minecraft", "dynamic", LootTable::Entry::Dynamic::creator
    );
    ...
    Server::getInstance()->getLootTableSystem().addEntryCreator(
        "minecraft", "loot_table", LootTable::Entry::LootTableEntry::creator
    );
    Server::getInstance()->getLootTableSystem().addEntryCreator(
        "minecraft", "sequence", LootTable::Entry::Sequence::creator
    );
}
